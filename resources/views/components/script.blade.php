...
<script src="{{ asset('template/vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js') }}">
</script>
<!-- Ion.RangeSlider -->
...
<script>
    ...
    function addItemPurchase() {
        ...
        var unitData = ["Unit 1", "Unit 2", "Unit 3"];

        // unitData.forEach(function(unit) {
        //     var option = document.createElement("option");
        //     option.text = unit;
        //     option.value = unit;
        //     input_unit.appendChild(option);
        // });
        fetch('/master-data/unit/getData')
