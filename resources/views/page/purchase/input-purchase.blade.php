                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-2 col-sm-2  form-group ">
                                    <input type="text" class="form-control"  readonly="readonly" id="inputSuccess2" placeholder="Kode">
                                </div>
                                <div class="col-md-4 col-sm-4  form-group ">
                                    <input type="text" class="form-control" readonly="readonly"  id="inputSuccess3" placeholder="No Akun">
                                </div>
                            </div>
                            <div class="item form-group">
