                            ...
                            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                @foreach($dataItem as $key => $item)
                                    <tr class="">
                                        ...
                                        <td>{{ $item['outlet_item']['selling_price']}}</td>
                                        <td>{{ $item['outlet_item']['minimum_stock']}}</td>
                                        <td>{{ $item['outlet_item']['percent_non_margin']}}</td>
                                        <td>
