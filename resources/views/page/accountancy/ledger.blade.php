    ...
    <div class="">
        ...
        <div class="row no-print">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Buku besar <small>Nama / id outlet</small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" >S/D Akun <span class="required">*</span>
                                </label>
                                <div class="col-md-4 col-sm-4 form-group">
                                    <input type="text" id="first-name" readonly="readonly" class="form-control" placeholder="Nama Akun">
                                </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-3 col-sm-3 form-group radio">
                                    <input type="radio" checked="" value="option1" id="optionsRadios1" name="optionsRadios"> berdasarkan tanggal dan jam
                                </div>
                                <div class="col-md-3 col-sm-3 form-group radio">
                                    <input type="radio" checked="" value="option1" id="optionsRadios1" name="optionsRadios"> berdasarkan no referensi
                            </div>
