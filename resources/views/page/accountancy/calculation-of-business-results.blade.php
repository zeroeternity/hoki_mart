    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Laporan Perhitungan hasil usaha</h3>
            </div>
        </div>
        ...
        <div class="row no-print">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Form Laporan Perhitungan hasil usaha <small>Nama / id outlet</small></h2>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group checkbox">
                                <label class="col-form-label col-md-3 col-sm-3" > <span class="required">*</span>
                                </label>
                                <input type="checkbox" class="flat" checked="checked"> PHU Summary
                                </div>
                            </div>
