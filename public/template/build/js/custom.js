...
function init_sparklines() {
    ...
    $(".sparkline_pie").sparkline([1, 1, 2, 1], {
        type: "pie",
        sliceColors: ["#568203", "#ccc", "#75BCDD", "#D66DE2"],
    });
...
function init_morris_charts() {
    ...
    if ($("#graph_bar").length) {
        Morris.Bar({
            ...
            labels: ["Geekbench"],
            barRatio: 0.4,
            barColors: ["#568203", "#34495E", "#ACADAC", "#3498DB"],
            xLabelAngle: 35,
            hideHover: "auto",
            resize: true,
        });
    ...
    if ($("#graph_area").length) {
        Morris.Area({
            ...
            lineColors: ["#568203", "#34495E", "#ACADAC", "#3498DB"],
    ...
    if ($("#graph_donut").length) {
        Morris.Donut({
            ...
            colors: ["#568203", "#34495E", "#ACADAC", "#3498DB"],
